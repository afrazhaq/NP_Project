...
async function startScreenSharing() {
  ...
  //await context.overridePermissions('https://www.example.com', ['screen']);
 ...
 // await page.goto('https://www.example.com'); // Replace with your desired URL
  ...
  const startSharingButton = await page.$("shareButton"); // Replace with the appropriate selector for your screen sharing button
  await startSharingButton.click();

  console.log('Screen sharing started...');

  // Wait for the screen sharing to continue
  // You can add additional logic here as per your requirements

  await browser.close();
}

startScreenSharing().catch(console.error);
